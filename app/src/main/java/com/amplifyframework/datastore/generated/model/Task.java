...
public final class Task implements Model {
    ...
    private final @ModelField(targetType = "String")
    String imgName;
    private final @ModelField(targetType = "Team", isRequired = true)
    @BelongsTo(targetName = "teamId", type = Team.class)
    Team team;
    ...
    private Task(String id, String title, String body, String state, String imgName, Team team) {
        this.id = id;
        this.title = title;
        this.body = body;
        this.state = state;
